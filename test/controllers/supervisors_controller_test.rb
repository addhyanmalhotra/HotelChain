...
class SupervisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supervisor" do
    assert_difference('Supervisor.count') do
      post supervisors_url, params: { supervisor: { department: @supervisor.department, emp_id: @supervisor.emp_id } }
    end
  ...
  test "should update supervisor" do
    patch supervisor_url(@supervisor), params: { supervisor: { department: @supervisor.department, emp_id: @supervisor.emp_id } }
